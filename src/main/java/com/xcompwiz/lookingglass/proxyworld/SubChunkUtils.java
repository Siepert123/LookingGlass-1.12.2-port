...
public class SubChunkUtils {
    public static boolean withinDistance(BlockPos pos, int x, int y, int z, int distance) {
        return distance * distance >= pos.distanceSq(x, y, z);
    }
    ...
    public static boolean withinRange(BlockPos pos, int x, int y, int z, int d1, int d2) {
        double cDistance = pos.distanceSq(x, y, z);
    ...
    public static boolean withingRange2D(int x, int z, int x2, int z2, int d1, int d2) {
        int x3 = x - x2;
        int z3 = z - z2;
